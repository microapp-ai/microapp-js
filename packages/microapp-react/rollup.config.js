  ...
  const webModules = [
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/microapp-react.development.js`,
        format: "esm",
        sourcemap: !PRETTY,
        banner,
      },
    ...
    },
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/microapp-react.production.min.js`,
        format: "esm",
        sourcemap: !PRETTY,
        banner,
      },
  ...
  const globals = [
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/umd/microapp-react.development.js`,
        format: "umd",
        sourcemap: !PRETTY,
        banner,
        globals: {
    ...
    },
    {
      input: `${SOURCE_DIR}/index.tsx`,
      output: {
        file: `${OUTPUT_DIR}/umd/microapp-react.production.min.js`,
        format: "umd",
        sourcemap: !PRETTY,
        banner,
        globals: {
