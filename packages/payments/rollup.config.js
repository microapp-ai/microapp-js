...
function getRollupConfig(
  ...
  return {
    ...
    output: {
      ...
      sourcemap: !PRETTY,
      banner,
      ...(format === 'umd' ? { name: 'MicroappPayments' } : {}),
    },
    plugins: [
...
module.exports = function rollup() {
  return [
    getRollupConfig('esm', 'payments.js', { includeTypesAndCopy: true }),
    getRollupConfig('cjs', 'payments.cjs.js'),
    getRollupConfig('umd', 'payments.umd.js'),
    getRollupConfig('umd', 'payments.umd.min.js', { minify: true }),
  ];
};
