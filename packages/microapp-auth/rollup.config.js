...
module.exports = function rollup() {
  return [
    getRollupConfig("esm", "microapp-auth.js", { includeTypesAndCopy: true }),
    getRollupConfig("cjs", "microapp-auth.cjs.js"),
    getRollupConfig("umd", "microapp-auth.umd.js"),
    getRollupConfig("umd", "microapp-auth.umd.min.js", { minify: true }),
  ];
};
